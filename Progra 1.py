...
def menuusuario():
    ...
    if opcion1=="1":
        ...
        print("")
        asignaclientes=eval(input("Digite el nombre del cliente:"))
        asignadestino=eval(input("Digite el código de destino: "))
        existe(asignaclientes,asignadestino)
        print("")
        menuusuario()
    elif opcion1=="4":
        print("")
...
def existe(cliente, destino):
    ...
    if clientescop!=[] and lugarcop!=[]:
        if directo(cliente,destino):
            print("")
            print("Se ha usado una ruta directa")
            print("")
            return directoaux(cliente, destino)
        else:
            escalas(cliente,destino)
...
def directoaux(cliente, destino):
    ...
    for i in aerolineas:
        if i[2]==localizacion:
            ...
            pass
    return False
##calcula la ruta con escalas
def escalas(cliente,destino):
    global clientes
    global lugar
    global aerolineas
    localización=0
    ...
    for i in aerolineas:
        if i[2]==localizacion:
            ...
            print("W")
            return guardarescalas(cliente,destino,temp,temp2)
        else:
            pass
    
##escribir en el .txt de la factura(con escalas    
def guardarescalas(cliente,destino,precio,distancia):
    global clientes
    global lugar
    lugarvar=""
    for k in clientes:
    ...
    factura2="Viaje a",lugarvar
    factura3="Distancia",distancia
    factura4="Costo",precio
    lista1= str(factura1)
    lista2= str(factura2)
    lista3= str(factura3)
    lista4= str(factura4)
    if distancia==0 or costo==0:
        print("")
        print("Lo sentimos, no existe una ruta posible")
        print("")
        return menu()
    else:
    ...
    for m in lugar:
        if m[0]==destino:
            ...
            lugarvar=m[1]
             ...
             pass
    factura1= "Usuario",cliente
    factura2="Viaje directo de",estavar,"a",lugarvar
...
## calcula la aerolinea con más ventas y la con menos ventas
def estadisticas_aero():
    global aerolineas
    lista=[]
    masventas=0
    menosventas=0
    ...
    for i in aerolineas:
        lista=lista+[i[4]]
    masventas=max(lista)
    menosventas=min(lista)
    for i in aerolineas:
        if i[4]==masventas:
            masventasstr=masventasstr+" "+i[1]
        elif i[4]==menosventas:
            menosventasstr=menosventasstr+" "+i[1]
    print("Aerolínea(s) con más ventas")
    print(masventasstr)
    print("Aerolínea(s) con menos ventas")
    print(menosventasstr)
